...
<div class="data-information">
  <form method="POST">
    <label>Prénom : <input name="firstname" type="text" value="<?= $vars['firstname'] ?> "></label><br>
    <label>Nom : <input name="lastname" type="text" value="<?= $vars['lastname'] ?> "></label><br>
    <label>Adresse email : <input name="email" type="email" value="<?= $vars['email'] ?> "></label></br>
